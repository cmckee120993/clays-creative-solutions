         ...
         <div className="about">
            ...
            <div className="about-info">
                <p lang='fr'>
                    ...
                    Je suis actuellement un doctorant dans la domaine de litérature comparée à l'Université de Californie à 
                    Los Angeles, et j'ai reçu une certification du développement web ful stack, aussi de l'Université de Californie
                    à Los Angeles. La diversité de mes experiences me pemetrra de vous aider avec toutes sortes des tâches: la
                    ...
                    regardant votre projet pour une estimation ou pour voire si je peux vous aider à réaliser vos objectifs.
                </p>
                <p lang='fr'>
                    Récemment, j'ai décidé de sortir de l'éducation où j'ai enseigné des cours de litérature et de langue, et j'ai fait des
                    recherches en anglais, arabe, français et espagnol. Je prospère dans des environnements solitaires et collaboratifs quand
                    je peux combiner mes compétences analytiques, logiques et investigatives dans les domaines que j'ai développé à travers ma
